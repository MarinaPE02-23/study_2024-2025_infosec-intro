...
Развили навыки администратирования OC Linux. Получиди первое практическое знакомство с технологией SELinux 
Проверили работу на практике совместно с веб-сервером Apache
